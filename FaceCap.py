...
class FaceCap(bpy.types.Operator):

    bl_idname = "wm.opencv_operator"
    bl_label = "FaceCap"

    p = "D:\Documents\shape_predictor_68_face_landmarks.dat" # Windows
...
def register():
    bpy.utils.register_class(FaceCap)

def unregister():
    bpy.utils.unregister_class(FaceCap)
